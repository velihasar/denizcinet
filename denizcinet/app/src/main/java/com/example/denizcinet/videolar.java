...
public class videolar extends AppCompatActivity {
    private WebView webView;
    private WebViewClient webViewClient;
    private String Url = "https://www.youtube.com/channel/UC_IPEn-ApX73nWUjT4aBh5Q?fbclid=IwAR2eTtxUwVHyZv-9iu74WteYfl8INbwuHP5HEetBvrdwPv9Phz33TvzMcgo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webViewClient = new WebViewClient();//CustomWebViewClient classdan webViewClient objesi oluşturuyoruz
